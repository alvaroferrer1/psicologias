  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-secondary-bg p-6">
      <div className="card w-full max-w-xl p-8 text-center">
        ...
        <h1 className="text-2xl font-extrabold text-secondary-text">Algo ha fallado</h1>
        <p className="mt-2 text-sm font-medium text-slate-500">
          La app ha recuperado el control para que puedas seguir trabajando sin quedarte bloqueada.
        </p>
        {error?.message && (
